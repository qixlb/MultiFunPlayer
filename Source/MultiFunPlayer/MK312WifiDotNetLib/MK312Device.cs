...
namespace RexLabsWifiShock
{
    ...
    public class MK312Device {
        ...
        public void initializeChannels() {
            ...
            cmd.poke((uint)MK312Constants.RAM.ChannelBFrequency, 30);
            cmd.poke((uint)MK312Constants.RAM.ChannelAWidthSelect, (byte)MK312Constants.Select.Static);
            cmd.poke((uint)MK312Constants.RAM.ChannelBWidthSelect, (byte)MK312Constants.Select.Static);
        }

        // Sets a value to the channel with adjustment
        public void setChannel(uint channeladdress, double value) {

            byte v = (byte)(value * 255);
            cmd.poke(channeladdress, v);          // Channel A: Set intensity value
        ...
        public void setChannelALevel(double a) {
            ...
            double gammaA = Math.Pow(a, 0.3);
            setChannel((uint)MK312Constants.RAM.ChannelAIntensity, gammaA);
        }
        ...
        public void setChannelBLevel(double b) {
            ...
            // Do value correction
            // double valueA = 115 + (80 * _fade) + ((a * 100) * 64 / 100);
            double gammaB = Math.Pow(b, 0.3);

            setChannel((uint)MK312Constants.RAM.ChannelBIntensity, gammaB);
        }
